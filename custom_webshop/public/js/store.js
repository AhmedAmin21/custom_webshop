...
const TRANSLATIONS = {
    en: {
        ...
        su_otp_channel_label: "How should we send your phone code?",
        su_otp_channel_sms: "SMS", su_otp_channel_whatsapp: "WhatsApp",
        ...
        su_switch_to_sms: "Send code by SMS instead", su_switch_to_whatsapp: "Send code by WhatsApp instead",
    ...
    ar: {
        ...
        cart_address_placeholder: "عنوان الشارع، الوحدة، المدينة، الولاية، الرمز البريدي...", cart_notes: "تعليمات التوصيل",
        cart_notes_placeholder: "ملاحظات", cart_proceed: "متابعة لإتمام الشراء",
        ...
        su_otp_channel_label: "كيف تريد استلام رمز الهاتف؟",
        su_otp_channel_sms: "رسالة نصية", su_otp_channel_whatsapp: "واتساب",
        ...
        su_switch_to_sms: "إرسال الرمز عبر رسالة نصية بدلا من ذلك",
        su_switch_to_whatsapp: "إرسال الرمز عبر واتساب بدلا من ذلك",
