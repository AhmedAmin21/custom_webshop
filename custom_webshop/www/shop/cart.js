...
var cartPath = shopBase + "/cart";
var paymentPath = shopBase + "/payment";

function isCartPage() {
	return window.location.pathname === cartPath || window.location.pathname === "/cart";
}

function paymentUrl(orderId) {
	return paymentPath + "?order_id=" + encodeURIComponent(orderId);
}
// Changes:
